...
from utils.chatbot import get_response_low_proc_high_dist
...
def main():
    ...
    <div style="
        ...
        To provide the most relevant aid information, please enter your ZIP code so we can direct you to the closest available resources.
    </div>
    """,
    unsafe_allow_html=True
)
    ...
    if "messages" not in st.session_state or not st.session_state.messages:
        chat_placeholder = "Please enter your ZIP code so we can direct you to the closest available resources."
    else:
    ...
    submit_to_database('03-chatbot-dist')
