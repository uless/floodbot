...
def main():
    ...
    <div style="
        ...
        Press 'Start chat' to begin. To provide the most relevant aid information, once you start, please enter your <b>ZIP code</b> so we can direct you to the closest available resources.
