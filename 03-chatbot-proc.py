...
from utils.chatbot import get_response_high_proc
...
def main():
    ...
    <div style="
        ...
        To make sure I provide you with the right information, let me explain how aid is being distributed. <br>
        Can you tell me your ZIP code so I can check what resources are available in your area?
    </div>
    """,
    unsafe_allow_html=True
)
    ...
    if "messages" not in st.session_state or not st.session_state.messages:
        chat_placeholder = "Can you tell me your ZIP code so I can check what resources are available in your area?"
    else:
    ...
    if user_input := st.chat_input(chat_placeholder):
        ...
        for message in st.session_state.messages:
            ...
            with st.chat_message("assistant",avatar=st.session_state['avatars']):
                ...
                response_gen = get_response_high_proc(user_input)
    ...
    submit_to_database('03-chatbot-proc')
